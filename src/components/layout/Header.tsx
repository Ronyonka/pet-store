    ...
    <div className="w-full bg-black py-2">
      <div className="container mx-auto flex items-center justify-center px-8">
        <span className="text-center text-sm font-medium tracking-wide text-white">
          FREE DELIVERY ON ALL ORDERS OVER KES 5,000 . FREE RETURNS
        </span>
      </div>
    </div>
  );
  ...
  return (
    <header className="w-full sticky top-0 z-50">
      ...
      >
        ...
        <div className="w-full flex justify-between items-center py-3 sm:py-4 bg-white/80 shadow-sm boder-b border-gray-100 backdrop-blur-sm">
          <div className="flex justify-between items-center container mx-auto px-8">
            <div className="flex flex-1 justify-start itemsx-center gap-4 sm:gap-6">
